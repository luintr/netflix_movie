            ...
            <div className='banner'>
                {isLoading ?
                    <div className='skeletonWrap'>
                        <Skeleton variant="rounded" animation="wave" sx={{ bgcolor: 'grey.900' }} width={`100%`} height={`100%`} />
                        <div className='banner-box'>
                            <div className='bannerTitle'>
                                <Skeleton variant="rounded" animation="wave" sx={{ bgcolor: 'grey.900' }} width={`100%`} height={60} />
                            </div>

                            <div className='flexDiv'>
                                <Skeleton variant="circular" animation="wave" sx={{ bgcolor: 'grey.900' }} width={60} height={60} />
                                <Skeleton variant="rounded" animation="wave" sx={{ bgcolor: 'grey.900' }} width={210} height={60} />
                            </div>
                    ...
                    <div className='wrap-content'>
                        ...
                        {!adult ? <div className='adult-tag'><p>13+</p></div> : <div className='adult-tag'><p>18+</p></div>}
                    </div>
                }
            </div>
        )
